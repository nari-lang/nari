...
struct Value {
    ...
    static Value make_int(int64_t v) { Value val; val.data = v; return val; }
    static Value make_float(double v) { Value val; val.data = v; return val; }
    static Value make_bool(bool v) { Value val; val.data = v; return val; }
    static Value make_string(std::string v) { Value val; val.data = std::move(v); return val; }
    ...
    static Value make_function(std::string name) {
        Value val; val.data = ValueFunction{std::move(name)}; return val;
    }
    ...
    bool is_function() const { return std::holds_alternative<ValueFunction>(data); }
    bool is_handle() const { return std::holds_alternative<HandlePtr>(data); }
    bool is_class_instance() const { return std::holds_alternative<ClassInstancePtr>(data); }
    ...
    const ValueFunction& get_function() const { return std::get<ValueFunction>(data); }
    const HandlePtr& get_handle() const { return std::get<HandlePtr>(data); }
    const ClassInstancePtr& get_class_instance() const { return std::get<ClassInstancePtr>(data); }
    ClassInstancePtr& get_class_instance() { return std::get<ClassInstancePtr>(data); }
    ...
    std::string to_string(bool in_container_context = false) const {
        return std::visit(overloaded {
            ...
            [](const ValueFunction& f) { return std::string("<function " + f.name + ">"); },
    ...
    double as_number() const {
        return std::visit(overloaded {
            ...
            [](const Array& a) { return a ? static_cast<double>(a->size()) : 0.0; },
            [](const Object& o) { return o ? static_cast<double>(o->size()) : 0.0; },
